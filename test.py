...
#  pl_per = abs(pl_diff / p_sum)
  vl1_per = abs(vl_diff * v_sum)
  pl1_per = abs(pl_diff * p_sum)
#  vp_per = vl_per / (vl_per + pl_per) * 100
  if(order_position == 1):
#    print(round(v_p_per,2),round(p_p_per,2))
#    print(vl_diff,pl_diff)
    print(round(vl1_per,2),round(pl1_per,2))
#    print(round(vp_per,2))
    print(ord_max, ord_min, ord_xnum, ord_nnum)
  limit_diff = ord_diff
