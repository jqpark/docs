#v5_test14-8-2_SMA020_250811-1700
#v5 api
#retry code -> v5_test14-8-1_SMA020_250723-1620 -> v5_test14-7-0_SMA020_250704-1100
...
#-------------------------------------------------------------------------------
  ...
  elif(ready_p < 30) and (lower_per > 30): order_position = 1
...
#            order_condition[item_no] = 'order_cancel'
        ...
        if(order_idx[1] == 1) and (value_v_list[item_no][0] != 1):
...
#              order_condition[item_no] = 'L_order_cancel'
        ...
        if(order_idx[2] == 2) and (value_v_list[item_no][0] != 2):
