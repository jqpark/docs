#v5_test14-12-10_MAIN_JQ_251211-1200
#v5 api
...
#-------------------------------------------------------------------------------
        ...
        l_tp_ex_price = str(sym_price + (limit_diff_p[item_no] * 1) + float(tick_size))
        ...
        s_tp_ex_price = str(sym_price - (limit_diff_p[item_no] * 1) - float(tick_size))
